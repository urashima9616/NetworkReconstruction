...
Num_S_repeats = 100; % to get P-value for S; min P = 0.001 for 1000 samples
I = 0.95;
...
% network
load("fb_graph.mat")  % loads struct of data in "Problem"; adjacency matrix is Problem.A

A = full(adjacency(G)); % convert into full from sparse format
