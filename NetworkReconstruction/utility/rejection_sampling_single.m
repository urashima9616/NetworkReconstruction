...
function [A_obs, index_array, victim_likelihood, flag] = rejection_sampling_single(A_obs, P_k, psi, idx, sequence_missing, alpha, index_array)
...
if idx == length(sequence_missing) + 1
    ...
    while trial < 10
        ...
        [A_obs, index_array, victim_likelihood_current, success] = draw_one_step(A_obs, P_k, psi, idx, sequence_missing, alpha, index_array);
        if success == 0
           flag = 0;
           victim_likelihood = 0;
           return
            ...
            [A_obs, index_array, victim_likelihood_rest, success] = rejection_sampling_single(A_obs, P_k, psi, idx + 1, sequence_missing, alpha, index_array);
            if success == 1
