function [A_obs, index_array, victim_likelihood_current, success, norm_factor_max, degree_array_max] = draw_one_step_random_attack_opt_nonsym(A_obs, P_k, psi, idx, sequence_missing, alpha, index_array, norm_factor, degree_array)
